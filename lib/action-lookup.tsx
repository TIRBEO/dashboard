...
const ACTIONS: ActionRule[] = [
  ...
  { match: ["suspicious_login.denied", "suspicious", "blocked"], icon: ShieldAlert, color: "#ef4444", labelKey: "history.act.suspiciousLoginDenied", category: "security" },
  ...
  { match: ["recovery_email", "auth.login_recovery_email"], icon: Mail, color: "#3b82f6", labelKey: "history.act.loginRecovery", category: "security" },
  ...
  { match: ["user.banned"], icon: ShieldAlert, color: "#ef4444", labelKey: "history.act.accountBanned", category: "security" },
  ...
  { match: ["security.login", "security.password_changed", "security.deletion_cancelled"], icon: Shield, color: "#3b82f6", labelKey: "history.act.securityEvent", category: "security" },
  ...
  { match: ["recovery_email.removed"], icon: Mail, color: "#ef4444", labelKey: "history.act.recoveryEmailRemoved", category: "account" },
  ...
  { match: ["data_export", "data.export"], icon: CreditCard, color: "#3b82f6", labelKey: "history.act.dataExportRequested", category: "account" },
  { match: ["account.delete-request", "account.delete_request"], icon: AlertTriangle, color: "#ef4444", labelKey: "history.act.deleteAccountRequested", category: "account" },
  ...
  { match: ["user.deleted.scheduled", "user.deleted", "user.soft_delete"], icon: Trash2, color: "#ef4444", labelKey: "history.act.deleteAccountRequested", category: "account" },
  ...
  { match: ["preferences.updated", "notification_preferences"], icon: Bell, color: "#3b82f6", labelKey: "history.act.preferencesUpdated", category: "account" },
  { match: ["privacy.consent", "privacy.data_request"], icon: Eye, color: "#3b82f6", labelKey: "history.act.privacyAction", category: "account" },
  { match: ["bookmark", "saved"], icon: Bookmark, color: "#8b5cf6", labelKey: "history.act.bookmarkAction", category: "account" },
  { match: ["connected", "oauth.connected"], icon: Globe, color: "#3b82f6", labelKey: "history.act.oauthConnected", category: "account" },

  // ─── Tickets ─────────────────────────────────────────────
  { match: ["ticket.created", "ticket_created"], icon: MessageSquare, color: "#3b82f6", labelKey: "history.act.ticketCreated", category: "tickets" },
