...
__export(src_exports, {
  ...
  formatNepaliPhone: () => formatNepaliPhone,
  getBsMonthName: () => getBsMonthName,
  getCache: () => getCache,
  getCookieDomain: () => getCookieDomain,
  getCurrentBsDate: () => getCurrentBsDate,
  getDaysInBsMonth: () => getDaysInBsMonth,
  getPhoneType: () => getPhoneType,
  isCurrentSubdomain: () => isCurrentSubdomain,
  isValidNepaliPhone: () => isValidNepaliPhone,
  loginUrl: () => loginUrl,
  redirectToSubdomain: () => redirectToSubdomain,
  setCache: () => setCache
});
